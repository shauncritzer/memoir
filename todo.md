# Shaun Critzer Website - Project TODO

## Phase 1: Website Foundation ✓
- [x] Initialize web project with database and auth
- [x] Design homepage with memoir pitch and email capture
...
- [ ] Build YouTube video embed system

## Phase 5: Membership Platform
- [ ] Design membership tiers
- [ ] Build membership sales page
...
- [ ] Create automated content distribution
- [ ] Set up AI avatar content system

## Technical Infrastructure
- [x] Set up database schema for blog posts
- [x] Set up database schema for email subscribers
- [x] Set up database schema for lead magnets
- [x] Create user management system (built-in)
- [ ] Build payment integration (Stripe)
- [ ] Set up file storage for digital products
...
## URGENT: Restore REWIRED Method Page & Build 7-Day Reset Course - January 15, 2026
- [x] Find REWIRED Method page in git history
- [x] Restore REWIRED Method page with color-coded sections and interactive questions
- [x] Add REWIRED Method link back to navigation
- [x] Upload all 7 Day videos to S3 (Day 1-7 MP4 files)
- [x] Upload all 7 Day slide PDFs to S3
- [x] Upload Living Sober (Thriving Sober) PDF to S3
- [x] Create course database schema for 7-Day Reset
- [x] Build course member area with video player
- [x] Add downloadable PDFs for each day
