          ...
          const lessonData = [
            {
              ...
              posterUrl: `${R2_BASE}/thumbnails/Day_1.jpg`,
            ...
            },
            {
              ...
              posterUrl: `${R2_BASE}/thumbnails/Day_2.jpg`,
            ...
            },
            {
              ...
              posterUrl: `${R2_BASE}/thumbnails/Day_3.jpg`,
            ...
            },
            {
              ...
              posterUrl: `${R2_BASE}/thumbnails/Day_4.jpg`,
            ...
            },
            {
              ...
              posterUrl: `${R2_BASE}/thumbnails/Day_5.jpg`,
            ...
            },
            {
              ...
              posterUrl: `${R2_BASE}/thumbnails/Day_6.jpg`,
            ...
            },
            {
              ...
              posterUrl: `${R2_BASE}/thumbnails/Day_7.jpg`,
        ...
        const moduleData = [
          {
            ...
            sortOrder: 1,
            lessons: [
              { day: 1, title: "Day 1: The Trauma-Addiction Connection", desc: "Addiction is not a moral failing — it's a survival strategy. When we experience trauma, especially in childhood, our brains learn to cope through avoidance, numbing, and escape. The progression: (1) Trauma occurs, (2) Emotions become overwhelming, (3) Coping mechanisms develop, (4) Substances are introduced, (5) Addiction takes hold. Today you'll map your addiction timeline — from first use to rock bottom. For each major event, note what happened, what you were feeling, and what trauma it connected to. Understanding this progression doesn't excuse your behavior, but it explains it. And explanation is the first step toward healing.\n\nExercise: Create your addiction timeline. For each event, note the feelings and the childhood trauma it connects to.\n\nAffirmation: 'My addiction was not a moral failing. It was a survival strategy. I am ready to heal the wounds that made me need to escape.'" },
              { day: 2, title: "Day 2: Sobriety vs. Recovery", desc: "There's a critical difference most people miss: sobriety removes the substance, but recovery heals the wound underneath it. You can be sober and still be in tremendous pain — white-knuckling through life, managing anxiety without tools, carrying shame from your past. That's survival, not recovery.\n\nRecovery means healing the childhood trauma, processing the shame you've carried since you were eight, reconnecting with the inner child who still believes they're unlovable. This course goes to the root — we're not just removing the coping mechanism, we're healing what made you need to cope in the first place.\n\nExercise: On a scale of 1-10, rate where you are on the sobriety-to-recovery spectrum. What areas of your life still feel 'broken' even though you're sober? Write them down honestly." },
              { day: 3, title: "Day 3: Your Core Wound", desc: "Beneath every addiction is a core wound — a deep, unconscious belief about yourself that drives self-destructive behavior. Common core wounds: 'I am unlovable,' 'I am not safe,' 'I am worthless,' 'I am too much / not enough,' 'I am alone.'\n\nThese beliefs formed in childhood when you didn't have the tools to process what was happening to you. They became the lens through which you saw everything — relationships, work, your own worth. Substances temporarily muted that core wound. Now, in recovery, the wound is exposed again.\n\nExercise: Identify your core wound. Write it down. Then write how this wound shows up in your daily life — in your relationships, your self-talk, your choices. This isn't about wallowing — it's about seeing clearly so you can heal intentionally." },
              { day: 4, title: "Day 4: Rewriting Your Story", desc: "You've been telling yourself a story about who you are — and most of it was written by your trauma. 'I'm the screw-up.' 'I'm the one who can't get it together.' 'I'm the addict.'\n\nToday we rewrite that story. You are not the villain — you are the survivor. Everything you went through, every rock bottom, every moment of shame — it was preparing you for this transformation. Your story isn't one of failure. It's one of resilience.\n\nExercise: Write two versions of your story. Version 1: The shame version (how you've been telling it). Version 2: The hero's journey version (same events, reframed as a story of survival and growth). Read Version 2 out loud. This is the true story.\n\nReflection: What surprised you about mapping your addiction timeline? How does understanding the trauma-addiction connection change how you see yourself?" },
            ],
          },
          {
            productId: "from-broken-to-whole",
            ...
            sortOrder: 2,
            lessons: [
              { day: 5, title: "Day 5: Shame vs. Guilt", desc: "Guilt says 'I did something bad.' Shame says 'I am bad.' This distinction changes everything.\n\nGuilt is productive — it motivates you to make amends and change behavior. Shame is destructive — it convinces you that you're fundamentally broken and unworthy of love.\n\nIn addiction, shame becomes a self-fulfilling prophecy: You feel shame → shame makes you feel worthless → feeling worthless makes you use → using creates more shame → the cycle continues.\n\nBreaking the shame cycle requires: (1) Naming the shame, (2) Sharing it with safe people — shame dies in the light, (3) Separating your worth from your behavior, (4) Practicing self-compassion.\n\nExercise: Write down your top 5 shame statements. For each one, rewrite it separating the behavior from your identity. Example: 'I'm a terrible father' → 'I was sick with addiction and couldn't show up the way they deserved. That was my disease, not my character.'" },
              { day: 6, title: "Day 6: Talking to Yourself Like a Friend", desc: "Would you say to a friend what you say to yourself? Most people in recovery have a brutal inner critic — a voice that punishes them for every mistake, reminds them of every failure, and tells them they don't deserve happiness.\n\nDr. Kristin Neff's self-compassion framework has three pillars: (1) Self-kindness over self-judgment — treat yourself with the same warmth you'd give a struggling friend, (2) Common humanity over isolation — suffering is universal; you're not the only one who has struggled, (3) Mindfulness over over-identification — acknowledge pain without drowning in it.\n\nExercise: Write a letter to yourself from the perspective of an unconditionally loving friend. What would they say about your recovery journey? What would they say about the shame you carry? Read it every morning this week." },
              { day: 7, title: "Day 7: Forgiving Yourself", desc: "Self-forgiveness is the hardest work in recovery. Not because you don't understand it intellectually, but because that core wound keeps telling you that you don't deserve it.\n\nForgiveness doesn't mean forgetting. It doesn't mean what happened was okay. It means choosing freedom over self-hatred. It means putting down the backpack full of rocks you've been carrying.\n\nExercise: Write a forgiveness letter to yourself. Include: (1) What you're forgiving yourself for (be specific), (2) Acknowledgment that you were doing the best you could with the tools you had, (3) A commitment to self-compassion going forward, (4) Permission to stop punishing yourself.\n\nRead it out loud. If you cry, good. That's not weakness — that's release." },
              { day: 8, title: "Day 8: Building Self-Worth", desc: "Self-esteem is conditional — it rises and falls based on achievements, approval, and comparison. Self-worth is inherent — it exists simply because you exist.\n\nAddiction strips away self-esteem: you lose jobs, relationships, respect. But it can never touch your self-worth, because that's not something you earn. It's something you are.\n\nThe shift from self-esteem to self-worth is the shift from 'I am worthy because I do X' to 'I am worthy because I am.'\n\nExercise: List 10 things that make you worthy that have nothing to do with achievement. Not 'I'm a good worker' — things like 'I feel deeply,' 'I survived what would have broken most people,' 'I showed up today.' Post this somewhere visible.\n\nAffirmation: 'I am not defined by my past. I am defined by who I'm becoming. I forgive myself and I am worthy of a new beginning.'" },
            ],
          },
          {
            productId: "from-broken-to-whole",
            ...
            sortOrder: 3,
            lessons: [
              { day: 9, title: "Day 9: The Wounded Child Inside You", desc: "Your inner child is not a metaphor. It's the part of you that still feels the fear, shame, and loneliness of childhood.\n\nWhen your inner child is wounded and unhealed: You react to adult situations with childlike emotions (rage, terror, shame). You seek external validation to fill the void left by childhood neglect. You use substances to numb the pain that child is still carrying.\n\nWhen you heal your inner child: You can respond with adult wisdom instead of childlike reactivity. You can give yourself the love and validation you didn't receive. You no longer need substances to escape that child's pain.\n\nExercise: Find a quiet space. Close your eyes. Take three deep breaths. Visualize yourself as a child — whatever age feels right. Ask: How old am I? What am I wearing? Where am I? What expression is on my face? What do I need right now? Write what you saw." },
              { day: 10, title: "Day 10: Reparenting Yourself", desc: "Reparenting means giving your inner child what they needed but didn't receive. It's the most powerful healing work you can do in recovery.\n\nWhat did your inner child need? Safety and protection. Unconditional love. Validation of feelings. Healthy boundaries. Encouragement and praise. Physical affection. Consistency and stability. Permission to play and have fun.\n\nExercise: Write a letter to your younger self. Tell them what they needed to hear. Example: 'Dear 8-year-old Shaun, I know you're scared. I know you feel alone. I know you think it's your fault that Dad drinks and Mom is always angry. But it's not. You are not responsible for their pain. You are a good kid. You are worthy of love. I'm here now, and I will protect you.'\n\nWrite your letter. Then read it aloud to yourself — you're reading it to that child inside you who's been waiting to hear these words." },
              { day: 11, title: "Day 11: Healing Childhood Wounds", desc: "Today we go deeper into the specific wounds that shaped you.\n\nTrauma Inventory — acknowledge what happened: Physical abuse, Sexual abuse, Emotional abuse, Neglect (physical or emotional), Parental addiction, Parental mental illness, Divorce or family separation, Death of a parent or sibling, Bullying, Poverty or housing instability, Witnessing domestic violence.\n\nFor each item that applies, write one sentence about how it affected you. This isn't about reliving trauma — it's about acknowledging it so it loses its power over you.\n\nProfessional support matters: EMDR (Eye Movement Desensitization and Reprocessing) processes traumatic memories at a neurological level. IFS (Internal Family Systems) works with different 'parts' of yourself. Somatic Experiencing releases trauma stored in the body. If you're dealing with severe trauma, these therapies combined with this course create powerful healing." },
              { day: 12, title: "Day 12: Integration and Wholeness", desc: "Healing isn't about erasing the past or splitting yourself into 'good' and 'bad' parts. It's about integration — bringing all parts of yourself home.\n\nThe wounded child. The angry teenager. The addict. The recovery warrior. They're all you. And they all deserve a seat at the table.\n\nIntegration means: Acknowledging all parts of your experience without shame. Understanding that your 'dark side' was a survival mechanism, not evil. Embracing complexity — you can be both damaged and beautiful, both broken and whole.\n\nExercise: Write a short acknowledgment to each 'part' of yourself: Your inner child ('I see you. You are safe now.'), Your adolescent self ('Your anger made sense. I honor your fight.'), Your addicted self ('You were trying to survive. I forgive you.'), Your recovering self ('You are brave. Keep going.')\n\nAffirmation: 'The child I was deserved better. The adult I am can give them what they need. I am healing from the inside out.'" },
            ],
          },
          {
            productId: "from-broken-to-whole",
            ...
            sortOrder: 4,
            lessons: [
              { day: 13, title: "Day 13: Trauma Lives in the Body", desc: "You can talk about your childhood for years in therapy and still feel the panic in your chest, the tension in your shoulders, the knot in your stomach. That's because trauma lives in the body.\n\nYour nervous system has three states: (1) Ventral Vagal (Safe and Social) — calm, connected, present, (2) Sympathetic (Fight or Flight) — anxious, angry, panicked, (3) Dorsal Vagal (Freeze/Shutdown) — numb, dissociated, depressed.\n\nIn addiction, you're constantly cycling between fight/flight and freeze — using substances to escape anxiety, anger, depression, numbness. Recovery requires learning to recognize which state you're in and use tools to return to safety.\n\nExercise: Right now, which state are you in? What sensations do you notice? Tight chest? Shallow breathing? Clenched jaw? Numbness? Write it down. This awareness is the first step to regulation." },
              { day: 14, title: "Day 14: Breathwork — Your Nervous System Remote Control", desc: "Your breath is the most powerful free tool you have for nervous system regulation. Here are three techniques you'll use daily:\n\n5-4-3-2-1 Grounding: Name 5 things you see, 4 you can touch, 3 you can hear, 2 you can smell, 1 you can taste. This pulls you out of fight/flight into the present moment.\n\nBox Breathing: Breathe in 4 counts → Hold 4 counts → Breathe out 4 counts → Hold 4 counts → Repeat 5 times. Used by Navy SEALs to manage extreme stress.\n\n4-7-8 Technique: Breathe in 4 counts → Hold 7 counts → Breathe out 8 counts. The extended exhale activates your parasympathetic nervous system.\n\nExercise: Practice all three techniques right now. Rate your stress level 1-10 before and after each. Which one works best for you? That's your go-to tool when cravings or anxiety hit." },
              { day: 15, title: "Day 15: Moving Trauma Out of Your Body", desc: "When a deer escapes a predator, it shakes. That shaking releases the survival energy trapped in its nervous system. Humans are the only animals that suppress this natural release — and that's why trauma gets stuck.\n\nMovement is medicine for trauma. Not just exercise — intentional, body-aware movement that releases trapped survival energy.\n\nBilateral Stimulation (EMDR-inspired): Tap alternating knees or shoulders, or cross arms and tap alternating biceps. Continue for 2-3 minutes while thinking of a safe place. This stimulates both hemispheres of the brain.\n\nBuild your somatic toolkit — check what resonates: Yoga, Walking in nature, Dancing, Cold showers, Progressive muscle relaxation, Massage or bodywork, Stretching, Deep breathing, Humming or singing.\n\nExercise: Commit to trying at least 3 of these practices this week. Track how your body feels before and after each one." },
              { day: 16, title: "Day 16: EMDR and Professional Trauma Therapy", desc: "EMDR (Eye Movement Desensitization and Reprocessing) is one of the most effective treatments for trauma. It works by having you recall traumatic memories while following bilateral stimulation (eye movements, taps, or sounds). This helps your brain process and integrate the memory so it no longer triggers the same intense emotional response.\n\nOther evidence-based trauma therapies: Somatic Experiencing (SE) — focuses on body sensations to release trauma, Internal Family Systems (IFS) — works with different 'parts' of yourself, Neurofeedback — trains your brain to regulate itself, CPT (Cognitive Processing Therapy) — structured approach to reprocessing trauma.\n\nThis course gives you tools and framework. A qualified trauma therapist gives you personalized guidance. Both together create the most powerful healing.\n\nExercise: Research one trauma therapist in your area or online. Write down their name and number. You don't have to call today — just take the step of finding one.\n\nAffirmation: 'My body is not my enemy. It's been trying to protect me. I am learning to listen to it and care for it.'" },
            ],
          },
          {
            productId: "from-broken-to-whole",
            ...
            sortOrder: 5,
            lessons: [
              { day: 17, title: "Day 17: The Wreckage of Addiction", desc: "Addiction doesn't happen in isolation. You've lied, manipulated, broken promises, and hurt the people who love you. Acknowledging this isn't about drowning in shame — it's about seeing clearly so you can make it right.\n\nExercise: Relationship Inventory. List the people your addiction hurt. For each person, name: (1) The relationship (parent, partner, child, friend), (2) The specific harm you caused, (3) How it affected them. Be thorough but compassionate. You were sick. This inventory isn't punishment — it's clarity.\n\nImportant: You cannot expect people to trust you just because you're sober now. Trust is rebuilt through consistent behavior over time, radical honesty, following through on commitments, respecting boundaries, and making amends without expecting forgiveness." },
              { day: 18, title: "Day 18: Making Amends That Matter", desc: "Not all amends are equal. There are three types:\n\n1. Direct Amends: Face-to-face conversation where you acknowledge specific harm, take responsibility, and ask how you can make it right. Use when: the person is accessible and contact won't cause more harm.\n\n2. Living Amends: Changed behavior over time. You don't say 'I'm sorry' — you show it through consistent trustworthy action. Use when: direct contact would hurt them, or when words aren't enough.\n\n3. Indirect Amends: Service to others, paying it forward, or making a symbolic gesture. Use when: the person has passed away or is unreachable.\n\nFor each person on your inventory, determine which type of amends is appropriate. Discuss with a sponsor, therapist, or trusted mentor before making direct amends.\n\nExercise: Pick one person. Write out exactly what you would say in a direct amends. Practice it out loud. Get feedback from your sponsor." },
              { day: 19, title: "Day 19: Setting Healthy Boundaries", desc: "Boundaries are not walls — they're bridges with gates. They let the good in and keep the harmful out.\n\nIn active addiction, you had no boundaries. You said yes to everything that fed the addiction and no to everything that threatened it. In recovery, you need to flip that script.\n\nTypes of boundaries you need: Physical boundaries (who can touch you, enter your space), Emotional boundaries (what emotional labor you'll take on), Time boundaries (how you spend your time), Substance boundaries (people, places, situations that trigger cravings), Digital boundaries (social media, late-night texting, toxic content).\n\nExercise: Identify 3 boundaries you need to set this week. For each one, write: (1) The boundary, (2) Why it matters for your recovery, (3) Exactly what you'll say if someone crosses it. Practice saying them out loud." },
              { day: 20, title: "Day 20: Building New Connections", desc: "Johann Hari said, 'The opposite of addiction is not sobriety. The opposite of addiction is connection.' Recovery happens in community.\n\nQualities to look for in recovery relationships: Honesty, Mutual respect, Healthy boundaries, Emotional safety, Accountability, Shared values, Support for your recovery.\n\nWhere to find these connections: Recovery meetings (AA, NA, SMART Recovery), Therapy groups, Sober activities and events, Volunteering and service, Faith communities, Online recovery communities.\n\nExercise: (1) List 3 people in your life who embody these qualities. How can you invest more in these relationships? (2) Identify one new community you'll join this week (a meeting, group, class, or volunteer opportunity). (3) Reach out to one person today. Not about recovery — just about connection.\n\nAffirmation: 'I cannot undo the past, but I can build a different future. I am becoming someone worthy of trust.'" },
            ],
          },
          {
            productId: "from-broken-to-whole",
            ...
            sortOrder: 6,
            lessons: [
              { day: 21, title: "Day 21: What Do You Value?", desc: "Recovery isn't just about not using. It's about building a life so good you don't want to escape from it. That starts with knowing what you value.\n\nRank these values from 1 (most important) to 10: Family, Health, Creativity, Service/Helping others, Financial security, Adventure, Spirituality/Faith, Learning/Growth, Authenticity, Community/Belonging.\n\nNow look at your top 3. Ask yourself: How am I currently living in alignment with these values? Where am I out of alignment?\n\nThe gap between your values and your daily life is where dissatisfaction lives. Closing that gap is how you build a life worth staying sober for.\n\nExercise: For your top 3 values, write one specific action you can take this week to live more aligned with each one." },
              { day: 22, title: "Day 22: Your Strengths Inventory", desc: "Addiction convinced you that you have nothing to offer. That's the shame talking. Let's correct the record.\n\nList at least 5 strengths, skills, or talents you have. They don't have to be professional — things like empathy, resilience, storytelling, humor, creativity, physical strength, emotional intelligence, determination. If you're stuck, ask someone who knows you well.\n\nNow think about this: How can you use these strengths in service of your recovery or to help others? Your greatest pain, transformed by recovery, becomes your greatest gift.\n\nExercise: For each strength, write one way you could use it to help someone else in recovery this week. Service is one of the most powerful relapse prevention tools." },
              { day: 23, title: "Day 23: Your Purpose Statement", desc: "To build a meaningful life in recovery, answer three questions: (1) What do I value? (What matters most to me?), (2) What am I good at? (What are my strengths and gifts?), (3) What does the world need? (How can I contribute?)\n\nWhere these three overlap is your purpose.\n\nExercise: Complete this sentence:\n'I am here to _________________________ by using my strengths in _________________________ to serve _________________________.'\n\nExample: 'I am here to help others find hope in recovery by using my strengths in storytelling and vulnerability to serve people who feel broken and alone.'\n\nYour purpose statement doesn't have to be perfect. It just has to be honest. Write it, refine it, and put it somewhere you'll see it daily." },
              { day: 24, title: "Day 24: Living in Alignment", desc: "Knowing your values and purpose means nothing if you don't live them. Today is about closing the gap between intention and action.\n\nLook at your purpose statement. Now look at how you spent last week. How much of your time was aligned with your stated values and purpose? Be honest — not harsh, just honest.\n\nThe 1% Rule: You don't have to overhaul your life overnight. Just move 1% closer to alignment each day. One small step toward purpose today.\n\nExercise: (1) Write down one thing you'll do TODAY that aligns with your purpose, (2) Write down one thing you'll STOP doing this week that takes you out of alignment, (3) Schedule a weekly 'alignment check-in' — 10 minutes every Sunday to review how you're living vs. how you want to live.\n\nAffirmation: 'My life has meaning. My story has purpose. I am here for a reason.'" },
            ],
          },
          {
            productId: "from-broken-to-whole",
            ...
            sortOrder: 7,
            lessons: [
              { day: 25, title: "Day 25: The God-Shaped Hole", desc: "Many people in recovery talk about a 'God-shaped hole' — a deep longing for connection, meaning, and transcendence that substances temporarily filled.\n\nYou don't need to believe in God. But you do need to believe in something beyond your own willpower. Spirituality in recovery is about: Surrendering control, Trusting a process bigger than yourself, Finding connection and belonging, Experiencing awe, gratitude, and wonder, Aligning with values and purpose.\n\nExercise: What is your relationship to spirituality right now? (Strong faith? Spiritual but not religious? Agnostic? Angry at God? Exploring?) Write honestly — there's no wrong answer. Then answer: What DO you believe in? Nature? Humanity? Love? The universe? Science? Connection? Name it." },
              { day: 26, title: "Day 26: Spiritual Practices for Recovery", desc: "Spirituality isn't a belief — it's a practice. It's something you DO, not just something you think about.\n\nPractices that connect you to something greater: Prayer (formal or informal), Meditation (guided or silent), Time in nature (walking, sitting, observing), Music (listening, playing, singing), Art or creativity (writing, painting, building), Service to others (volunteering, helping, giving), Reading sacred texts or poetry, Gratitude practice (daily list of 3 things you're grateful for), Community and fellowship.\n\nExercise: Pick 3 practices from the list above. Commit to practicing one of them daily for the next week. Track how it makes you feel — specifically, does it reduce the urge to escape? Does it create a sense of connection? That's spirituality working." },
              { day: 27, title: "Day 27: Surrender and Trust", desc: "Control is the illusion that kept you sick. You tried to control your drinking. You tried to control the consequences. You tried to control other people's perceptions of you. None of it worked.\n\nSurrender doesn't mean giving up. It means giving over. It's the recognition that your best thinking got you to rock bottom, and maybe — just maybe — there's a wisdom greater than your own.\n\nExercise: (1) What do you need to surrender control of right now? Write it down, (2) What would it look like to trust the process instead of trying to manage everything? (3) Write a 'surrender prayer' in your own words. Not religious if that doesn't work for you — just an honest statement of letting go.\n\nExample: 'I don't have all the answers. I trust that if I do the next right thing, the path will reveal itself. I release my need to control and I open myself to being guided.'" },
              { day: 28, title: "Day 28: Finding Your Community", desc: "Recovery is not a solo sport. You need a community of people who understand, who hold you accountable, and who remind you that you're not alone.\n\nOptions for building your spiritual support network: Recovery meetings (AA, NA, Refuge Recovery, SMART Recovery), Faith communities (if that resonates), Service organizations (volunteer work), Recovery coaching or mentorship, Online communities and support groups, This course community and the Bent Not Broken Circle.\n\nExercise: (1) Identify one community you'll commit to attending regularly, (2) Find one person who can be an accountability partner — someone you check in with weekly, (3) Write a 'community contract' with yourself: 'I commit to showing up to _____ at least _____ times per week because _____.''\n\nAffirmation: 'I am not alone. I am part of something bigger. I trust the process.'" },
            ],
          },
          {
            productId: "from-broken-to-whole",
            ...
            sortOrder: 8,
            lessons: [
              { day: 29, title: "Day 29: Your Recovery Maintenance Plan", desc: "Getting sober is an event. Recovery is a lifestyle. Long-term recovery requires: Daily practices (meetings, therapy, meditation, exercise), Ongoing self-awareness (recognizing warning signs), Community and connection, Continuous growth, Service to others.\n\nExercise: Design your recovery maintenance plan:\n\nDAILY: Morning routine (meditation, journaling, intention-setting), Afternoon check-in (nervous system state, stress level), Evening practice (gratitude list, reflection).\n\nWEEKLY: Meetings/therapy (how many, when?), Connection (who will you reach out to?), Self-care (what fills your cup?).\n\nMONTHLY: Progress check-in, Growth activities (books, courses, workshops), Service commitment.\n\nRelapse Prevention — Your Warning Signs: List your top 3 warning signs that you're in danger. Then write your action plan: Step 1 (call someone), Step 2 (go to a meeting), Step 3 (use a coping tool from this course). Post this where you'll see it daily." },
              { day: 30, title: "Day 30: Your Vision for the Future", desc: "You've done the deep work. You've mapped your trauma, healed your inner child, processed shame, rebuilt relationships, found purpose, and connected to something greater than yourself. You are not the same person who started this course 30 days ago.\n\nThe goal is not just to stay sober. The goal is to thrive.\n\nExercise: Write your vision:\n\nIn 1 year, I will: _____\nIn 5 years, I will: _____\nIn 10 years, I will: _____\n\nMake it specific. Make it bold. You've earned the right to dream again.\n\nFinal Reflection: (1) What's the most important thing you learned in this course? (2) How are you different now than when you started? (3) What are you most excited about for your future?\n\nCongratulations — you completed From Broken to Whole. This is not the end. This is the beginning. Your next steps: Review your exercises, share your progress with someone you trust, keep practicing daily, give back and help others who are struggling.\n\nContinue your journey with the Bent Not Broken Circle (monthly membership) for ongoing support and community.\n\nAffirmation: 'I am not just surviving. I am thriving. My best days are ahead of me.'\n\n— Shaun Critzer" },
            ],
          },
        ];
      ...
      .mutation(async ({ ctx }) => {
        ...
        const offers = [
          ...
          // === AFFILIATE TOOLS (lower weight) ===
          {
            ...
            affiliateUrl: "https://try.elevenlabs.io/7tu62ns5muha",
          ...
          },
          {
            ...
            affiliateUrl: "https://pictory.ai/?ref=shaun42",
            offerType: "affiliate" as const,
            weight: 9,
          ...
          },
          {
            ...
            affiliateUrl: "https://affiliates.gohighlevel.com/?fp_ref=digital-gravity-ai51",
            offerType: "affiliate" as const,
            weight: 10,
          ...
          },
          {
            ...
            affiliateUrl: "https://systeme.io/?sa=sa022859422340857ad748d1e66f74ad1e4461b50c",
            offerType: "affiliate" as const,
            weight: 9,
            platforms: JSON.stringify(["x", "linkedin", "facebook"]),
            status: "active" as const,
          ...
          {
            name: "GetResponse",
            description: "Email marketing and automation platform with AI features",
            ctaText: "Email marketing with AI - grow your audience on autopilot",
            ctaUrl: "https://shauncritzer.com/recommends/getresponse",
            affiliateUrl: "https://try.getresponsetoday.com/ixu014he4e17-xlkg1t",
            offerType: "affiliate" as const,
            weight: 9,
