...
export default function RewiredRelief() {
  ...
  // Box Breathing Timer Logic with Audio
              ...
              {gratitudePrompts.map((prompt, index) => (
                <div key={index} className="space-y-2">
                  ...
                  <textarea
                    ...
                    className="w-full p-3 border-2 border-gray-300 rounded-lg resize-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-all text-gray-900 bg-white"
                    rows={3}
    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-95 flex items-center justify-center z-50 p-4 backdrop-blur-sm">
          <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto border-2 border-amber-500">
            {/* Header */}
            <div className="sticky top-0 bg-gradient-to-br from-gray-900 to-gray-800 border-b border-amber-500 p-6 flex justify-between items-center">
              <div>
