        ...
        <div className="container max-w-3xl">
          <div className="prose prose-lg max-w-none space-y-8">
            ...
            <section className="space-y-6">
              <h2 className="text-3xl font-bold border-b pb-4">The Meaning Behind the Title</h2>

              <p className="text-xl italic text-center my-8">
                Deus escreve direito por linhas tortas —<br />
            ...
            <section className="space-y-6 my-16">
              <h2 className="text-3xl font-bold border-b pb-4">Author's Note</h2>

              <p className="font-semibold text-lg">This book is my fourth step on paper.</p>
              ...
              <p className="font-semibold">Here's why I'm sharing:</p>
              ...
              <p className="font-semibold">So I'm being that person for you.</p>
              ...
              <p>The path will reveal itself. I promise.</p>

              <p className="italic">One day at a time.</p>
            ...
            {/* Introduction */}
            <section className="space-y-6 my-16">
              <h2 className="text-3xl font-bold border-b pb-4">Introduction: Not What You'd Expect</h2>
              ...
              <p>From the outside, everything looked normal. Fine. Safe.</p>
              ...
              <p>It wasn't a straight path. Nothing about recovery ever is.</p>

              <p>
                But if you're reading this because you're struggling—with addiction, with trauma, with the weight of secrets you've carried too long—I want you to know something: <strong>You're not uniquely broken. You're not beyond hope. And you're not alone.</strong>
              </p>
              ...
              <p>He was right about the second part. But he was wrong about something else.</p>
              ...
              <p>He didn't know yet that God writes straight with crooked lines.</p>

              <p>But he was about to find out.</p>

              <p className="font-semibold text-lg">This is that story.</p>
            </section>
