  ...
  const products = [
    {
      ...
      tagline: "The Memoir",
      price: "$19.99",
      priceId: "price_1QRLsVC2dOpPzSOOLhpWrNSL", // Crooked Lines memoir (TEST MODE)
    ...
    },
    {
      ...
      price: "$27",
      priceId: "price_1SYt2tC2dOpPzSOOpg5Pw7eU", // 7-Day Reset (TEST MODE)
    ...
    },
    {
      ...
      price: "$97",
      priceId: "price_1SYt3KC2dOpPzSOOpAokfJUQ", // From Broken to Whole (TEST MODE)
    ...
    },
    {
      ...
      price: "$29/month",
      priceId: "price_1SYt3jC2dOpPzSOOR7dDuGtY", // Bent Not Broken Circle (TEST MODE)
