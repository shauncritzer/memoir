  ...
  const products = [
    ...
    },
    {
      ...
      features: [
        ...
        "Video teachings with Shaun's personal stories",
        "Neuroscience deep dives explaining why each practice works",
        "Guided meditations and visualizations",
        "Inner child healing and reparenting exercises",
        "Somatic practices: breathwork, EMDR-inspired, movement",
        "Weekly checkpoint assessments to track your growth",
        "Shame processing, self-forgiveness, and relationship repair",
